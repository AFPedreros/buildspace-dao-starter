...
const App = () => {
    ...
    const vote = useVote("0x406943E3A5107342cC5deD69026503f9ba945787");
    const token = useToken("0x29504A69a2A81F9030186de7F2F41Ef4cade1f4a");
    const editionDrop = useEditionDrop("0x60d6A1c99BED48d2437Aa291C225dA8d60a37D80");
